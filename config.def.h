...
static const char *fonts[]          = { "sans-serif:size=8", "Feather:size=7:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_d,      spawn,          SHCMD("$SCRIPTS/dmenu-launcher.sh") },
};
